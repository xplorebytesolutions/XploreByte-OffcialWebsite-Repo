            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Create no-code chatbots and interactive flows that understand
                  context, engage customers, and automate sales 24/7.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  ...
                  guide users towards action, whether it's booking a demo, making
                  a purchase, or resolving a support ticket.
                </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="bg-gray-100 rounded-2xl rounded-tl-none p-4 max-w-[80%]">
                        <p className="text-sm text-gray-800">
                          Hi there! 👋 How can I help you grow your business
                          today?
                        </p>
                      </div>
                    </div>
